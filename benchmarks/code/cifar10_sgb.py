...
def experiment_sgb():
    ...
    stream = NumpyStream(X_r, y_r, dataset_name="cifar10")
    ...
    for i in range(50000):
        ...
        if i > 0 and (i + 1) % 100 == 0:
            ...
            p_t = 0.0
            test_stream = NumpyStream(X_test, y_test, dataset_name="cifar10")
            start_time = time.perf_counter()
...
if args.all or args.sgb:
    ...
    for i in range(1):
        ...
        write_result(DIRECTORY + "results/sgb/cifar10_acc", sgb_acc_l)
        write_result(DIRECTORY + "results/sgb/cifar10_train_t", sgb_train_t_l)
        write_result(DIRECTORY + "results/sgb/cifar10_test_t", sgb_test_t_l)
        write_result(DIRECTORY + "results/sgb/cifar10_v_m", sgb_v_m_l, True)
        # write_result(DIRECTORY + "results/sgb/cifar10_n_node", sgb_n_node_l)
        # write_result(DIRECTORY + "results/sgb/cifar10_size", sgb_size_l, True)
